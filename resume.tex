...
\begin{bullets}
    ...
    \item Conducted site visits to oversee the installation of key components in interconnected eletrical systems across several large scale commercial projects, totaling over \bold{200,000 }{${\bold{ft}}^2$}.
\end{bullets}
\vspace{-2mm}
