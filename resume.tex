...
\sectionHeadingSmall{Embedded C, TIVA-C, Code Composer Studio}{Traffic Controller}{September 2024}
...
\end{bullets}
\vspace{-2mm}
\sectionHeadingSmall{Philips Hue API, Bash, SvelteKit, Vite, I2C}{Smart Sleep Hub}{September 2024 - Present}
...
\tools{VS Code, Git, GitHub, Bash, Code Composer Studio, XCode, MySQL, Core Data, Vite}
