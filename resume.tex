...
\educationHeading{California State University, Fullerton}{B.S/M.S in Computer Engineering, Minor in Computer Science}{May 2026}{ 3.6}
...
\begin{bullets}
    ...
    \item Conducted site visits to oversee the installation of key components in interconnected eletrical systems across several large scale commerical projects, totaling over \bold{200,000 }{${\bold{ft}}^2$}.
\end{bullets}
\vspace{-2mm}
...
\sectionHeadingSmall{Real-time centralized control system}{Traffic Controller}{September 2024}
...
\end{bullets}
\vspace{-2mm}
\sectionHeadingSmall{Smart device that improves your sleep environment}{Smart Sleep Hub}{September 2024 - Present}
...
\begin{bullets}
    ...
    \item Interfaced a \bold{Raspberry Pi 5} with a touchscreen to display a clock, enable sleep configuration, and view sleep data.
\end{bullets}
...
\skills{Python, C/C++, ARM, Linux, SPI, I2C, HTML, Javascript, TailwindCSS, Swift, SwiftUI}
\vspace{5mm}
